...
public record UpdateRecipeParameters(UUID id, UUID recipeUserId, String name, Integer cookTime,
    ...
    public UpdateRecipeParameters {
        ...
        Assert.notNull(recipeUserId, "The UpdateRecipeParameters recipeUserId should not be null");
