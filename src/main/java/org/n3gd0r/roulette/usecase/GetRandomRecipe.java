...
public class GetRandomRecipe implements RequestHandler<RandomRecipeQuery, Recipe> {

    private final RecipeRepository repository;

    public GetRandomRecipe(RecipeRepository repository) {
        this.repository = repository;
    }

    @Override
    public Recipe execute(RandomRecipeQuery request) {
